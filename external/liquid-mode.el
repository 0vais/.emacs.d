...
;;; core stuff
 ...
 ;;; liquid tag delimiters					
		("{%\s*\\(hightlight\\|endhighlight\\|assign\\|capture\\|endcapture\\|for\\|endfor\\|if\\|endif\\|comment\\|endcomment\\|else\\|elsif\\|unless\\|endunless\\|case\\|when\\|endcase\\|cycle\\)". font-lock-keyword-face ) ;;; liquid construct tags       					
...
(define-derived-mode liquid-mode fundamental-mode "Liquid"
  ...
  (set (make-local-variable 'font-lock-defaults) '(liquidKeywords nil t)))

;; (define-derived-mode liquid-mode fundamental-mode
